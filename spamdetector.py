# Simple spam detection model for NLP course
...
print(data.head()) # Displaying a few
...
#new_message = "OMG! Did you just win the lottery? Your girlfriend is SO pretty!!"
#new_message = "Hey its me, the guy from biology101."

# For this bait text message, the model makes a wrong prediction. Further improvements should be made.
new_message = "Congratulations! You have been selected for a free trial of our amazing weight loss product. Sign up today to start your journey!"
